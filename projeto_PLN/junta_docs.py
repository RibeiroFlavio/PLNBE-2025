...
JSON_SEMI_COMPLETO = 'json_completo.json'

junta_dicionario_glossario(DICIONARIO, GLOSSARIO, JSON_SEMI_COMPLETO)

GLOSSARIO_POPULAR = r'processamento_glossario_popular\gloss_final.json'
JSON_COMPLETO = 'json_completo.json'


junta_dicionario_glossario(JSON_SEMI_COMPLETO, GLOSSARIO_POPULAR,JSON_COMPLETO)